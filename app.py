...
def add_footer(story, styles):
    # Footer
    story.append(Paragraph("<b>Generated by ResumePilot AI</b>", styles["Heading2"] ))

    story.append(Paragraph("Thank you for using ResumePilot AI. Keep improving your resume and best of luck with your career!",
            styles["BodyText"]
        )
    )
